...
func TestReElection2A(t *testing.T) {
	...
	result1 := cfg.checkOneLeader()
	fmt.Println("Test ---- Expecting one leader Case 1:", result1)
	// if the old leader rejoins, that shouldn't
	// disturb the new leader.
	cfg.connect(leader1)
	leader2 := cfg.checkOneLeader()
	fmt.Println("Test ---- Expecting one leader Case 2:", leader2)
	...
	time.Sleep(2 * RaftElectionTimeout)
	cfg.checkNoLeader()
	fmt.Println("Test ----- Expecting no leader Case 3 passed")

	// if a quorum arises, it should elect a leader.
	cfg.connect((leader2 + 1) % servers)
	leader3 := cfg.checkOneLeader()
	fmt.Println("Test --- Expecting one leader Case 4:", leader3)

	// re-join of last node shouldn't prevent leader from existing.
	cfg.connect(leader2)
	leader4 := cfg.checkOneLeader()
	fmt.Println("Test --- Expecting one leader Case 5:", leader4)
...
func TestFailAgree2B(t *testing.T) {
	...
	fmt.Println("Starting Agreement with entry 102")
	cfg.one(102, servers-1, false)
	fmt.Println("Starting Agreement with entry 103")
...
func TestFailNoAgree2B(t *testing.T) {
	...
	fmt.Println("Started agreement with 1000")
